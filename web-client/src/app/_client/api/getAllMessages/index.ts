...
/**
 * Builds and executes requests for operations under /api/GetAllMessages
 */
 ...
 */
export const GetAllMessagesRequestBuilderUriTemplate = "{+baseurl}/api/GetAllMessages{?chatId*}";
/**
