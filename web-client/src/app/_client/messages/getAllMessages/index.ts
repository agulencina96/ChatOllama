...
// @ts-ignore
import {
  createIGetAllMessagesResponseFromDiscriminatorValue,
  type IGetAllMessagesResponse,
} from "../../models";
// @ts-ignore
import {
 ...
 */
export interface GetAllMessagesRequestBuilder
  extends BaseRequestBuilder<GetAllMessagesRequestBuilder> {
  /**
  ...
  get(
    requestConfiguration?:
      | RequestConfiguration<GetAllMessagesRequestBuilderGetQueryParameters>
      | undefined
  ): Promise<IGetAllMessagesResponse | undefined>;
  /**
   * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const GetAllMessagesRequestBuilderUriTemplate =
  "{+baseurl}/messages/GetAllMessages{?chatId*}";
/**
